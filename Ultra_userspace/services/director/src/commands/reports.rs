...
use super::tabla::{
    envolver, fila, fila_barra, fila_cero, fila_de, fila_mili, label, section,
    subregla,
};
...
/// ** EL DISCO vive en `disco.rs` desde el 2026-09-23: cuando el HBA, la
/// cache y el metro entraron en la tabla, este fichero cruzo las 1.000 lineas
/// (L6a). Se re-exporta para que `save` y la vista de ficheros sigan diciendo
/// `reports::report_disco` sin saber donde vive.
pub(crate) use super::disco::report_disco;
