...
| El COMPAS: el quantum se retira, el turno se concede | ABIERTA | `plan/PLAN_EL_COMPAS.md`: EX1, EX2 y EX3 HECHAS el 21-09 (la expropiacion al despertar, el cerrojo que se mide con nombre, y el CONTRATO por hilo de kernel: periodo + presupuesto, cobrado por turno, apartado si lo rompe; el quantum no se quita, se convierte -- queda como suelo para quien no declara); E0-E11 abiertas. Doctrina del dueno, 21-09: *"puedes salirte del rango PERO si cumples lo que eres; si no es parte de la musica, se saca a patada"*. Es el fantasma del planificador (`bmo-planificador-suelo`) |
