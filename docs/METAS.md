...
| El COMPAS: el quantum se retira, el turno se concede | ABIERTA | `plan/PLAN_EL_COMPAS.md`: EX1 y EX2 HECHAS el 21-09 (la expropiacion al despertar y el cerrojo que se mide con nombre); E0-E11 abiertas. Doctrina del dueno, 21-09: *"puedes salirte del rango PERO si cumples lo que eres; si no es parte de la musica, se saca a patada"*. Es el fantasma del planificador (`bmo-planificador-suelo`) |
