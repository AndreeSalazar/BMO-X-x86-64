...
`249a0f13` --*"un clic ya MARCA, no lanza"*-- convirtio el lanzamiento en doble
...
al centinela**, y en DOOM no hay tope. Ver `../plan/terminado/PLAN_DOOM.md`.
...
hacerla.** Agregada el 23-08 con el paso 2c construido.
