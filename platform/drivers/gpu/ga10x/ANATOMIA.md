...
| 25-09 ~21:30 | el primer arranque en frio SIN `fuego`/`frontera` levanta el GSP | el sospechoso del 0x15 es nuestro: el falcon del GSP tocado antes del booter (1 de 3). El caso: [`EL_0x15.md`](EL_0x15.md) |
