...
| `trabajos/` | VERDE | lienzo, blur, fractal, triangulo, raster, color3d, giro, pantalla, video, volcado, escena, cubo, tuberia, anillo | bytes y jueces; tocan la tarjeta por `motores` y `memoria` |
