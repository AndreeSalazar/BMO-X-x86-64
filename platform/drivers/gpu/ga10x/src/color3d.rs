...
pub const CODIGO_VS: [(u64, u64); 23] = [
    ...
    (0x00008008ff007322, 0x0003e80000000cff), // AST.128 a[0x80], R8 (el color); barrera de lectura 1
    (0x00007004ff007322, 0x0003e20000000cff), // AST.128 a[0x70], R4 (la posicion); barrera de lectura 1
    (0x000000000000794d, 0x002fea0003800000), // EXIT, esperando la barrera 1 (los AST), como NAK
