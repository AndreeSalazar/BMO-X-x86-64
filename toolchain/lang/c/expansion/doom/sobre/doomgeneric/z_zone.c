...
void Z_Free (void* ptr)
{
    ...
    // == CEPO BMO-X, TEMPORAL ==========================================
    { void bmo_zona_paso(char *que, int tam); bmo_zona_paso("Z_Free", block->size); }
}
  ...
  void*		user )
{
    ...
    // == CEPO BMO-X, TEMPORAL ==========================================
    // Solo habla cuando `bmo_vigilar(1)` lo arma. Ver `doomgeneric_bmo.c`.
    { void bmo_zona_paso(char *que, int tam); bmo_zona_paso("Z_Malloc", size); }
