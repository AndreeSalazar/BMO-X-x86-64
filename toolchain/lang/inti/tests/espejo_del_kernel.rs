...
const ESPEJO: &[(&str, Fuente, &str)] = &[
    ...
    ("verrano_lamina_magia", Fuente::Verrano("lamina.rs"), "MAGIA"),
    ("verrano_lamina_cabecera", Fuente::Verrano("lamina.rs"), "CABECERA"),
    ("verrano_campo_capacidad", Fuente::Verrano("lamina.rs"), "CAMPO_CAPACIDAD"),
    ("verrano_campo_secuencia", Fuente::Verrano("lamina.rs"), "CAMPO_SECUENCIA"),
    ("verrano_campo_vertices", Fuente::Verrano("lamina.rs"), "CAMPO_VERTICES"),
    ("verrano_campo_fotograma", Fuente::Verrano("lamina.rs"), "CAMPO_FOTOGRAMA"),
    ("verrano_campo_sello", Fuente::Verrano("lamina.rs"), "CAMPO_SELLO"),
